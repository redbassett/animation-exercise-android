...
import io.intrepid.animationexercise.AnimationexerciseApplication;
...
public abstract class BaseFragment<T extends BaseContract.Presenter> extends Fragment implements BaseContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PresenterConfiguration configuration = getAnimationexerciseApplication().getPresenterConfiguration();
    ...
    protected final AnimationexerciseApplication getAnimationexerciseApplication() {
        return (AnimationexerciseApplication) getActivity().getApplication();
    }
}
